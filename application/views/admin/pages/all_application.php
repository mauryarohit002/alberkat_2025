...
?>
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
            <h1>
                Application Master (ALL APPLICATION)
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">
                Application Master (ALL APPLICATION)</li>
            </ol>
        </section>
        <!-- Main content -->
                                        ...
                                        <tr class="tr_bottom">
                                            <form id="app_status_approve_<?php echo $cnt ?>">     
                                                ...
                                                <td>
                                                    ...
                                                    <br>
                                                    <a onclick="update_mob_no(<?php echo $value['rm_id'] ?>)" style="text-decoration: underline;color: #222d32;cursor: pointer;" >..LINK - UPDATE MOB</a>
