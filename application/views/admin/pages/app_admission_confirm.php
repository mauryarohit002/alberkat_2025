...
?>
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
            <h1>
                Application Master (CONFIRM)
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">
                Application Master (CONFIRM)</li>
            </ol>
        </section>
        <!-- Main content -->
            ...
            <form class="form-horizontal" id="report_search_form">
				<div class="form-group">
                    ...
                    <div class="col-sm-1">
                        ...
                        <input type="text" class="form-control cust_bt_border" value="CNT: <?php echo !empty($data_cnt)?$data_cnt:''?>" autocomplete="off" readonly> 
                    </div>
                    
                    <div class="col-sm-1">
                        <select name="div" class="form-control cust_bt_border" id="div">
                            <option value="0" <?php echo ($div =='0')?'selected':''?>>Division</option>
                            <option value="A" <?php echo ($div =='A')?'selected':''?>>A</option>
                            <option value="B" <?php echo ($div =='B')?'selected':''?>>B</option>
                            <option value="C" <?php echo ($div =='C')?'selected':''?>>C</option>
                            <option value="D" <?php echo ($div =='D')?'selected':''?>>D</option>
                            <option value="E" <?php echo ($div =='E')?'selected':''?>>E</option>
                        </select>
                    </div>
                    ...
                    <div class="col-sm-2">
                        ...
                        ?>   
                        <a href="<?php echo base_url('admin/cmaster/admission_confirm_print?'.$url)?>" class="btn btn-primary" style="width:20%;" target="_blank"><span class="glyphicon glyphicon-print"></span></a>

                        <a href="<?php echo base_url('admin/cmaster/admission_confirm_xls?'.$url)?>" class="btn btn-primary" style="width:30%;" target="_blank">Excel</a>

                        <a href="<?php echo base_url('admin/cmaster/id_card_xls?'.$url)?>" class="btn btn-primary" style="width:40%;" target="_blank">ID Card</a>
                    </div>
                                    ...
                                    ?>
                                        <tr class="tr_bottom">
                                            <form id="app_status_approve_<?php echo $cnt ?>">     
                                                ...
                                                <td>
                                                    <img src="<?php echo uploads($value['rm_child_photo'])?>" class="img-fluid" style="width: 120px;height: 150px;" >
                                                    <span style="text-align: right;"><a href="<?php echo uploads($value['rm_child_photo'])?>" download>Download</a></span>
                                                </td>
                                                <td align="center">
                                                ...
                                                <td>
                                                    ...
                                                    <select class="form-control dash_cust_drop_down" name="rm_child_division">        
                                                        <?php foreach ($division as $key1 => $value1) : ?>    
                                                            <option value="<?php echo $key1 ?>" <?php echo ($value['rm_child_division'] == $key1) ? 'selected' : '' ?>><?php echo $value1 ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                    <input type='text' name='rm_child_gr_no' class='form-control dash_cust_ip' placeholder='ENTER GR NO.' style='border-bottom:1px solid #ccc;' value="<?php echo $value['rm_child_gr_no'] ?>"  <?php echo ($value['rm_child_gr_no'] != "") ? "readonly" : "" ?>  >
                                                    <br/>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-success dash_cust_save" id="save_btn<?php echo $key ?>" onclick="app_status_update(<?php echo $value['rm_id']?>,<?php echo $cnt?>)">save</button>
                                                    <br/>
                                                    <br/>
                                                    <button type="button" class="btn btn-danger dash_cust_save" id="save_btn1<?php echo $key ?>" style="background: transparent;border-color: #000;color: #000;" onclick="open_cust_msg_box(<?php echo $value['rm_id']?>,<?php echo $cnt?>)">SMS</button>    
                                                </td> 
                                            </form> 
                                        </tr>
                                    <?php
