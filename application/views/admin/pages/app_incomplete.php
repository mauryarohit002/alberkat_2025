...
?>
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
            <h1>
                Application Master (INCOMPLETE)
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">
                Application Master (INCOMPLETE)</li>
            </ol>
        </section>
        <!-- Main content -->
                                        ...
                                        <tr class="tr_bottom">
                                            <form id="app_status_approve_<?php echo $cnt ?>">     
                                                ...
                                                <td>
                                                    ...
                                                    <input type="hidden" name="birth_date" value="<?php echo date('d-m-Y',strtotime($value['rm_child_birth_date'])) ?>">
                                                    <input type="hidden" name="mobile_no" value="<?php echo $value['rm_parent_mob_no'] ?>">
