...
?>
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
            <h1>
                Application Master (PENDING)
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">
                Application Master (PENDING)</li>
            </ol>
        </section>
        <!-- Main content -->
                                        ...
                                        <tr class="tr_bottom">
                                            <form id="app_status_approve_<?php echo $cnt ?>">     
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a href="<?php echo base_url('admin/cmaster/edit_student_reg_form/'.$value['rm_id']); ?>" class="glyphicon glyphicon-edit dash_cust_btn_tp" target="_blank" ></a>
                                                    <!-- <button class="glyphicon glyphicon-print dash_cust_btn_tp" onClick="print_teach_form(<?php echo $value['rm_id'] ?>);"></button> -->
                                                </td>
                                                <td>
                                                    <select class="form-control dash_cust_drop_down" name="rm_app_status" id="rm_app_status_<?php echo $cnt?>" onchange="add_th_td(this.value,<?php echo $cnt ?>)">        
                                                ...
                                                <td>
                                                    <input type='text' name='rm_desc_date' class='form-control dash_cust_ip dash_date' id="rm_desc_date_<?php echo $cnt?>" placeholder='DATE' style='border-bottom:1px solid #ccc;' value="<?php echo ($value['rm_desc_date'] =='0000-00-00')?'':date('d-m-Y',strtotime($value['rm_desc_date'])) ?>" ><br/>
                                                    <textarea type='text' class='form-control dash_cust_ip' name='rm_desc' id="rm_desc_<?php echo $cnt?>" placeholder='DESCRIPTION'><?php echo $value['rm_desc']?></textarea></td>
                                                <td>
