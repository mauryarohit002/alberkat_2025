...
?>
<script>
    var link = "app_pending";
    var sub_link = "app_pending";
</script>
				  	...
				  	<div class="tab-pane active" id="a1a">
	          			<!-- <h3>Content's background color is the same for the tab</h3> -->
		          			...
		          			<div class="form-group">
	                            ...
	                            <label for="inputEmail3" class="col-md-2 col-md-offset-1 control-label">Aadhar Card No.</label>
	                            <div class="col-md-3">
	                        ...
	                        <br>
	                        <div class="form-group">
	                        	<label for="inputEmail3" class="col-md-2 control-label">Standard</label>
	                            <div class="col-md-3 col-xs-12">
	                            	<?php echo form_dropdown('',['NURSERY'=>'NURSERY','JRKG'=>'JRKG','SRKG'=>'SRKG'],(!empty($student_data))?$student_data[0]['rm_child_class']:'NURSERY','class="form-control cust_ip_border" id="rm_child_class" name="rm_child_class"'); ?>
	                            </div>
	                            <label for="inputEmail3" class="col-md-2 col-md-offset-1 control-label">Division</label>
	                            <div class="col-md-3 col-xs-12">
	                            	<?php echo form_dropdown('',[''=>'Please Select','A'=>'A','B'=>'B','C'=>'C','D'=>'D','E'=>'E','F'=>'F'],(!empty($student_data))?$student_data[0]['rm_child_division']:'','class="form-control cust_ip_border" id="rm_child_division" name="rm_child_division"'); ?>
	                            </div>
	                        </div>
                       		<br>
                        	<div class="form-group">
	                        ...
	                        <div class="form-group">
	                        	...
	                        	<div class="col-md-3 col-xs-12">
	                            	<input type="date" class="form-control cust_ip_border" name="rm_child_birth_date" value="<?php echo (empty($student_data)?'':$student_data[0]['rm_child_birth_date'])?>" placeholder="DATE OF BITRH" title="Date of Bitrh" />
	                            </div>
	                            <label for="inputEmail3" class="col-md-1 control-label">Mobile Number</label>
	                        	<div class="col-md-3 col-xs-12">
	                            	<input type="text" class="form-control cust_ip_border" name="rm_parent_mob_no" value="<?php echo (empty($student_data)?'':$student_data[0]['rm_parent_mob_no'])?>" placeholder="Login number" title="Login number" />
	                            </div>
	                        </div>
	                        <br>
	                        <div class="form-group">
					...
					<div class="tab-pane" id="a2a" style="margin-top: 30px;">
	                        ...
	                        <div class="row">
								<div class="col-md-2 col-md-offset-4 col-xs-6">
									<button type="button" class="btn btn-success" id="sbt_btn" onClick="<?php echo (empty($student_data)?"update_student_data(0)":"update_student_data(".$student_data[0]['rm_id'].")")?>" style="width:100%;">SAVE</button>
								</div>
								<div class="col-md-2 col-xs-6">
									<a href="#" type="button" class="btn btn-danger" onclick="window.close();" style="width:100%;">Cancel</a>
								</div>
							</div>
