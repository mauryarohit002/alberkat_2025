...
<style>
	...
	<table class="marg">
		<tr>
			<td style="">
				...
				<br/><span style="text-align:left;color:#333;">SCHOOL CODE : 30252</span> </h5>
				<!--<img src="<?php echo assets('images/albarkaat_letter_head3.jpg')?>">-->
				
			</td>
			<td align="middle">
				<h5><span style="text-align:right;color:#333;">An ISO : 9001 - 2015 Certified School</span></h5>
	...
	<table>
		<tr>
			...
			<td>
				<br>
				<h3 class="text-center" style="font-weight:bold;text-decoration:underline;color:#333;">ONLINE APPLICATION FORM 2025-2026</h3>
			</td>
		</tr>
	</table>
	<table cellspacing="5">
	    <tr>
	        <td style="width:27%;text-align:center;font-weight: bold;font-size: 16px;">PEN ID:</td>
	        <td style="width:10%;"></td>
	        <td style="width:27%;text-align:center;font-weight: bold;font-size: 16px;">GR. NO:</td>
	        <td style="width:10%;"></td>
	        <td style="width:27%;text-align:center;font-weight: bold;font-size: 16px;">STD/DIV:</td>
	    </tr>
	     <br>
	    <tr>
	        <td style="width:27%;border-bottom: 1px solid #000;padding:0 1rem;"></td>
	        <td style="width:10%;"></td>
	        <td style="width:27%;border-bottom: 1px solid #000;"></td>
	        <td style="width:10%;"></td>
...
<style>
	...
	.marg{
		...
		<tr class="tr_even">
			<th class="pr_title">FATHERS MOBILE NO.</th>
			<td class="pr_data"><?php echo $app[0]['rm_child_family_phone_no'];?></td>
			<th class="pr_title">MOTHER MOBILE NO.</th>
			<td class="pr_data"><?php echo $app[0]['rm_child_family_mob_no'];?></td>
		</tr>
		<tr class="tr_odd">
		...
		<tr class="tr_odd">
			...
			<td class="pr_data"><?php echo ((!empty($app[0]['rm_child_guardian_phone_no']))?$app[0]['rm_child_guardian_phone_no']:$app[0]['rm_child_family_phone_no'])." / ".((!empty($app[0]['rm_child_guardian_mobile_no']))?$app[0]['rm_child_guardian_mobile_no']:$app[0]['rm_child_family_mob_no'])?></td>
		</tr>
		<tr class="tr_even">
			<th class="pr_title">EMAIL</th>
	...
	<table cellpadding="5" class="table">
		<tr class="headline"><td colspan="2" class="pr_header" ><h4 class="header_title">Instructions</h4></td></tr>
        <tr>
        	<td style="font-size:10px; width: 4%;font-weight: bold; text-align:center;">a]</td>
        	<td style="font-size:10px; width: 96%;">Parents seeking admission in <b>Pre-Primary Section</b> are requested to submit the updated Aadhar Card and Birth Certificate of their child issued by the Municipal Corporation (in English only). For admission from <b>Standard I to X,</b> preceding School Leaving Certificate, along with the updated Aadhar Card and Birth Certificate issued by the Municipal Corporation (in English only), must be submitted. The school will not assume responsibility for confirming admission or processing fee refund if admission is pursued without submitting mandatory mentioned documents.</td>
        </tr>
        <tr>
            <td style="font-size:10px; width: 4%;font-weight: bold;">b]</td>
            <td style="font-size:10px; width: 96%;">Al - Barkaat Malik Muhammad Islam English School is a <b>PRIVATE</b> and <b>PERMANENTLY UNAIDED</b> institute and does not receive any grant from the government and any other sources.</td>
        </tr>
        <tr>
            <td style="font-size:10px; width: 4%;font-weight: bold;">c]</td>
            <td style="font-size:10px; width: 96%;">As a private unaided institute and given that the school already maintains a reasonable fee structure in comparison to its contemporaries, parents are urged not to request any concession or relaxation in the school fees.</td>
        </tr>
		...
		<!--		and <b>PERMANENTLY UNAIDED</b> institute and does not receive any grant from the government and any other sources.</p>-->
		<!--		<p style="font-size:10px;"><b>c]  </b> As a private unaided institute and given that the school already maintains a reasonable fee structure in comparison to its contemporaries, parents are urged not to request any concession or relaxation in the school fees.</p>-->
		...
		<!--		<p style="font-size:10px;"><b>f]  </b> Parents are urged to communicate with the school management and authorities in a respectful language and refrain from using derogatory or unparliamentary language. If found to behaving to the contrary, strict action will be taken against the violator.</p>-->
  <!--          </td>-->
		<!--</tr>-->
	</table>
...
<style>
	...
	<table cellpadding="5" class="table">
	    <tr>
            ...
            <td style="font-size:10px; width: 96%;">Parents are requested to settle their monthly fee installments on or before the <b>10th</b> day of every calendar month.</td>
        </tr>
        <tr>
            <td style="font-size:10px; width: 4%;font-weight: bold;">e]</td>
            <td style="font-size:10px; width: 96%;">Fees once paid, are non-refundable/transferable under any circumstances.</td>
        </tr>
        <tr>
            <td style="font-size:10px; width: 4%;font-weight: bold;">f]</td>
            <td style="font-size:10px; width: 96%;">Parents are urged to communicate with the school management and authorities in a respectful language and refrain from using derogatory or unparliamentary language. If found to behaving to the contrary, strict action will be taken against the violator.</td>
        </tr>
			<!--<tr>-->
			<!--	<td>-->
			<!--	<p style="font-size:10px;"><b>g]  </b> Parents are requested to refrain from making defamatory or derogatory remarks about the institute on any search engine or Social Media platforms. In the event of a violation, appropriate action will be initiated against the offender.</p>-->
			<!--	<p style="font-size:10px;"><b>h]  </b> Parents are requested to abstain themselves from involvement, participation, or association with any group, either offline or online, that is politically/socially motivated and harbors malicious intentions to discredit the school's reputation.</p>-->
        ...
        <tr>
        	<td style="font-size:10px; width: 4%;font-weight: bold;">g]</td>
        	<td style="font-size:10px; width: 96%;">Parents are requested to refrain from making defamatory or derogatory remarks about the institute on any search engine or Social Media platforms. In the event of a violation, appropriate action will be initiated against the offender.</td>
        </tr>
        <tr>
        ...
        <tr>
        	...
        	<td style="font-size:10px; width: 96%;">Parents are requested to ensure the punctuality of their children, especially those who employ private or third-party transportation services to drop them off and pick them up from the school.</td>
        </tr>
        <tr>
        	<td style="font-size:10px; width: 4%;font-weight: bold;">j]</td>
        	<td style="font-size:10px; width: 96%;">As the school does not offer any transportation services, parents are at liberty either to personally drop off and pick up their child from the school or engage the services of any private or third-party transportation at their own risk and cost. The school, will not assume any responsibility in the event of any untoward incident that may occur during transportation.</td>
        </tr>
        <tr>
        	<td style="font-size:10px; width: 4%;font-weight: bold;">k]</td>
        	<td style="font-size:10px; width: 96%;">The school fees referenced in the Application Form are subject to change from time to time at the discretion of the management without any prior notification. At present the fee structure for new admission for academic year <b>2025-2026</b> for pre-primary section (Nursery/Junior/Senior), is Rs: 58600/- Per Annum, w.e.f. April-2025 to March-2026.</td>
        </tr>
        <tr>
        	<td style="font-size:10px; width: 4%;font-weight: bold;">l]</td>
        	<td style="font-size:10px; width: 96%;">The school management is at liberty to add to, amend, vary, alter and/or rescind any of the instructions mentioned hereinabove.</td>
        </tr>
	</table>
	<br><br>
	<br/>
	<table cellpadding="6" class="table table-striped">
		...
		<!--<tr>-->
		<!--	<td class="t_n_c">-->
		<!--		<p style="font-size:10px;"> &nbsp; &nbsp;  &nbsp; I, the undersigned Parent/Guardian of Master/ Miss <b><?php echo $app[0]['rm_child_surname']." ".$app[0]['rm_child_name']." ".$app[0]['rm_child_father_name']?> </b>, seeking admission in <b><?php echo $app[0]['rm_child_class']; ?></b> for the academic year 2025-26 do hereby solemnly declare & undertake as under:	</p>-->
		<!--	</td>-->
		<!--</tr>-->
		<!--<tr>-->
		<!--	<td class="t_n_c">-->
		...
		<!--</tr>-->
		<tr class="headline">
		<td colspan="2" class="pr_header"><h4 class="header_title">Under Taking Cum Declaration</h4></td>
	</tr>
	<tr>
		<!--<td class="t_n_c">-->
		    <td style="font-size:10px; width: 4%;font-weight: bold;"> </td>
			<td style="font-size:10px; width: 96%;"> I, the undersigned Parent/Guardian of Master/ Miss <b><?php echo $app[0]['rm_child_surname']." ".$app[0]['rm_child_name']." ".$app[0]['rm_child_father_name']?> </b>, seeking admission in <b><?php echo $app[0]['rm_child_class']; ?></b> for the academic year 2025-26 do hereby solemnly declare & undertake as under:	</td>
		<!--</td>-->
	</tr>
	<tr>
		<td style="font-size:10px; width: 4%;font-weight: bold;">a]</td>
		<td style="font-size:10px; width: 96%;">I have read all the applicable Rules and Regulations, Instructions, Guidelines and Eligibility Criteria related to admission.</td>
	</tr>
	<tr>
		<td style="font-size:10px; width: 4%;font-weight: bold;">b]</td>
		<td style="font-size:10px; width: 96%;">The information filled in by me in this form is complete, correct and true to the best of my knowledge & belief. I will personally be responsible and liable for any discrepancy arising out of any incorrect, incomplete documentation, or details filled by me in the admission form.</td>
	</tr>
	<tr>
		<td style="font-size:10px; width: 4%;font-weight: bold;">c]</td>
		<td style="font-size:10px; width: 96%;">I understand that if admission to my child is delayed, denied or cancelled, on account of any reason, including the availability of seats & submission of incorrect information and/or documents, then I shall not hold the school or its staff responsible for the consequences thereof, and/or as a result, the school is entitled for any monetary or other consequences.
			I undertake to indemnify the school without any demur.</td>
	</tr>
	<tr>
		<td style="font-size:10px; width: 4%;font-weight: bold;">d]</td>
...
<style>
	...
	<tr>
		<td style="font-size:10px; width: 4%;font-weight: bold;">f]</td>
		<td style="font-size:10px; width: 96%;">I hereby undertake that the school will not be liable for any damages or charges on account of any misfortune, or injuries which may be sustained by my child at any time while taking part in any curricular, or extracurricular activities, or while participating in sports, or during travelling or any other normal activities, or by contracting any illness or disease inside or outside the school premises. All expenses that may be incurred on the treatment of such injuries will be borne by me.</td>
	</tr>
	</table>
		<table cellpadding="6" class="table table-striped">	
		<!--<tr>-->
		...
		<!--		<p style="font-size:10px;"><b>j]  </b> I understand that Al - Barkaat Malik Muhammad Islam English School is a private unaided institute. Nevertheless, I voluntarily choose to enroll my child in the school.</p>-->
		...
		<!--		I have no disputes or objections regarding the fees, instructions mentioned hereinabove, and rules and regulations of the institute.</p>-->
...
<tr>
	<td style="font-size:10px; width: 4%; font-weight: bold;">g]</td>
	<td style="font-size:10px; width: 96%;">I comprehend that the school may capture videos and Photographs of myself and of my child for inclusion in the School Prospectus, Brochures, School Website, Social Media Channels, and other multipurpose educational needs as and when required. I undertake to give My Consent/No Objection to using mine and my child’s videos and Photographs, and I affirm that I shall not demand any monetary benefit or compensation in return.</td>
</tr>
<tr>
	<td style="font-size:10px; width: 4%; font-weight: bold;">h]</td>
	<td style="font-size:10px; width: 96%;">I undertake to abide by the decisions and actions taken by the school authorities from time to time in maintaining discipline, and the decision of the authorities shall be final.</td>
</tr>
<tr>
	<td style="font-size:10px; width: 4%; font-weight: bold;">i]</td>
	<td style="font-size:10px; width: 96%;">I authorize the school to take disciplinary action in the interest of my child in case he/she does not abide by the rules & regulations mentioned in the school policy. I undertake to accept the decision in this regard.</td>
</tr>
<tr>
	<td style="font-size:10px; width: 4%; font-weight: bold;">j]</td>
	<td style="font-size:10px; width: 96%;">I understand that Al - Barkaat Malik Muhammad Islam English School is a private unaided institute. Nevertheless, I voluntarily choose to enroll my child in the school.</td>
</tr>
<tr>
	<td style="font-size:10px; width: 4%; font-weight: bold;">k]</td>
	<td style="font-size:10px; width: 96%;">I declare and undertake to abstain from challenging, either personally or on behalf of any other parent and vice versa, the existing and future fee structure of the school.</td>
</tr>
<tr>
	<td style="font-size:10px; width: 4%; font-weight: bold;">l]</td>
	<td style="font-size:10px; width: 96%;">I undertake to pay the school fees regularly within the stipulated date as mentioned by the school authority. Failing this, I understand that it would result in additional late fines, and penalties, along with strict actions as set out in school norms.</td>
</tr>
<tr>
	<td style="font-size:10px; width: 5%; font-weight: bold;">m]</td>
	<td style="font-size:10px; width: 95%;">I undertake that I shall not initiate any legal or other proceedings against the school authorities and its staff for any mishappening or disciplinary action taken by the school.</td>
</tr>
<tr>
	<td style="font-size:10px; width: 4%; font-weight: bold;">n]</td>
	<td style="font-size:10px; width: 96%;">I understand and acknowledge that this Application Form may be presented to the concerned authorities for necessary purposes as and when required. I hereby declare that
	I have no disputes or objections regarding the fees, instructions mentioned hereinabove, and rules and regulations of the institute.</td></tr>
<tr>
	<td style="font-size:10px; width: 4%; font-weight: bold;">o]</td>
	<td style="font-size:10px; width: 96%;">I undertake to abide by the Rules and Regulations made thereunder, as per the school policy, and shall not act contrary there to.</td>
</tr>
<tr>
	<td style="font-size:10px; width: 4%; font-weight: bold;">p]</td>
	<td style="font-size:10px; width: 96%;">I hereby declare that I have carefully read and understood the contents stated hereunder, and I voluntarily affix my signature without any fear or favor, coercion or undue influence from anybody.</td>
</tr>
<tr>
	<td style="font-size:10px; width: 4%; font-weight: bold;">q]</td>
	<td style="font-size:10px; width: 96%;">I hereby grant my CONSENT, UNDERTAKING AND EXPRESS NO OBJECTION, authorizing the School Management to proceed with the admission procedure.</td>
</tr>
	</table>
...
<style>
	...
	<table border="1" cellpadding="5">
		<tr>
			<td colspan="10">Detail of Child's Siblings (Studying in this institute)</td>
		</tr>
		<tr>
			<td width="8%;" class="pr_title_bt">GR NO.</td>
			<td width="25%" class="pr_title_bt">NAME</td>
			<td width="10%" class="pr_title_bt">STD/<br/>DIV</td>
			<td width="16%;" class="pr_title_bt">Fees Detals</td>
			<td width="25%" class="pr_title_bt">ACADEMIC PROGRESS</td>
			<td width="16%" class="pr_title_bt">Class Teacher</td>
		</tr>
		<tr>
	...
	<table cellpadding="5">
		<tr>
		    <td style="width: 70%">1) Interaction Incharge Tr Name:_______________________________</td>
		    <td>Signature:_________________</td>
		</tr>
		<br>
		<tr>
		    <td style="width: 70%">2) Interaction Incharge Tr Name:_______________________________</td>
		    <td>Signature:_________________</td>
		</tr>
	</table>
...
<style>
	...
	<br>
	<table>
		<tr><td width="33%" class="pr_title_bt"><b>STUDENT'S OBSERVATION REPORT :</b></td><td width="67%" style="text-align:left;border-bottom: 1px solid #000;"> </td></tr>
	...
	<br>
	<table>
		<tr><td width="32%" class="pr_title_bt"><b>DOCUMENT VERIFIED AND COLLECTED :</b></td><td width="68%" style="text-align:left;border-bottom: 1px solid #000;"> </td></tr>
		<tr><td style="border-bottom: 1px solid #000;"><br><br></td><td  style="border-bottom: 1px solid #000;"> </td></tr>
	</table>
	<br>
	<br>
	<br>
	<table>
		<tr><td width="20%" class="pr_title_bt"><b>DOCUMENT PENDING :</b></td><td width="80%" style="text-align:left;border-bottom: 1px solid #000;"> </td></tr>
		<tr><td style="border-bottom: 1px solid #000;"><br><br></td><td  style="border-bottom: 1px solid #000;"> </td></tr>
	</table>
	<br>
	<br>
	...
	<table>
		<tr>
			...
			<td>
				<br>
				<span class="pr_title_bt" style="font-size: 11px;text-align: center;">PRINCIPAL SIGNATURE</span>
			</td>
			<td>
				<br>
