											...
											<td valign="top">
												<table class="print_table" ><!-- First Column -->
													<tr><td width="35%"><b>FORM NO:</b></td><td style="text-align:left;border-bottom: 1px solid #000;" width="65%"><?php echo $app[0]['rm_app_no'];?></td></tr>
										         	<tr><td><b>NAME OF THE FATHER:</b></td><td style="text-align:left;border-bottom: 1px solid #000;"><span id="rm_fp_fr_fname"><?php echo $app[0]['rm_child_father_name'];?></span>&nbsp;<span id="rm_fp_fr_mname"><?php echo $app[0]['rm_child_father_middle_name'];?></span>&nbsp;<span id="rm_fp_fr_lname"><?php echo $app[0]['rm_child_father_last_name'];?></span></td></tr>
										         	<tr><td><b>EDUCATIONAL QUALIFICATION:</b></td><td style="text-align:left;border-bottom: 1px solid #000;"><span id="rm_fp_fr_quli"><?php echo $app[0]['rm_child_father_qualification'];?></span></td></tr>
										         	<tr><td><b>NAME OF THE MOTHER:</b></td><td style="text-align:left;border-bottom: 1px solid #000;"><span id="rm_fp_mr_name"><?php echo $app[0]['rm_child_mother_name'];?></span></td></tr>
										         	<tr><td><b>EDUCATIONAL QUALIFICATION:</b></td><td style="text-align:left;border-bottom: 1px solid #000;"><span id="rm_fp_mr_quli"><?php echo $app[0]['rm_child_mother_qualification'];?></span></td></tr>
										...
										<tr>
											<td valign="top" width="55%">
												<table class="print_table" ><!-- First Column -->
													...
													<tr><td width="56%"><b>(A)OCCUPATION OF FATHER:</b></td><td width="44%" style="text-align:left;border-bottom: 1px solid #000;">  <?php echo $app[0]['rm_child_father_occupation'];?></td></tr>
											...
											<td valign="top" width="45%">
												<table class="print_table" ><!-- First Column -->
													<tr><td></td><td > </td></tr>
													<tr><td width="60%"><b>(B)MONTHLY EARNINGS:</b></td><td width="40%" style="text-align:left;border-bottom: 1px solid #000;">  <?php echo "Rs.".$app[0]['rm_child_family_monthly_income']."/-";?></td></tr>
										        </table><!-- First Column End -->
											</td>
										...
										<tr>
											<td valign="top">
												<table class="print_table" ><!-- First Column -->
													...
													<tr><td width="30%"><b>CHILD'S NAME:</b></td><td width="70%" style="text-align:left;border-bottom: 1px solid #000;">  <?php echo $app[0]['rm_child_name']." ".$app[0]['rm_child_father_name']." ".$app[0]['rm_child_surname']?></td></tr>
										...
										<tr>
											<td style="width:100%; text-align:left;">
												...
												<?php
													if(!empty($st))
													{	
														foreach($st as $key => $v1)
														{
												?>
															<tr>
																<td style="" ><?php echo $st[$key]['sbltr_gr_no'];?></td>
																<td style="" ><?php echo $st[$key]['sbltr_sbl_name'];?></td>
																<td style="" ><?php echo $st[$key]['sbltr_sbl_std'];?></td>
																<td style="" ><?php echo $st[$key]['sbltr_sbl_div'];?></td>
																<td style="" ><?php echo $st[$key]['sbltr_sbl_roll_no'];?></td>
															</tr>
												<?php
														}
													}
