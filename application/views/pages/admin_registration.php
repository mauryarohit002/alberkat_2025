				  	...
				  	<div class="panel-body">
				  		...
				  		<h4 class="text-center" style="margin-bottom: 30px;font-weight: bold;">GENERAL TERMS & CONDITIONS</h4>
					   	<p style="text-align: justify-all;">
					   		<b>1.</b>	The online application portal for Nursery will start from 14th December 2022 on the mentioned link: https://albarkaatadmissions.com/2023.<br/>
					   		<b>The above mentioned link will open on 14th Dec-22 @ 10 am & will close on 10th Jan-23 @ 4 pm.</b>
					   	</p>
					   	<p style="text-align: justify-all;">
					   	...
					   	<p style="text-align: justify-all;">
							<b>4.</b>	Child /Applicant for whom admission is desired should be born between 01st Oct 2019 to 30th Sep 2020. (Inclusive for all the days)
					   	</p>
					   	<p style="text-align: justify-all;">
							<b>5.</b>	Compulsory Details/Documents to be uploaded.
					   	</p>
					   	<p style="text-align: justify-all;">
							&nbsp&nbsp&nbsp a.	Parent should register his own Mobile No; at the time of online application registration.
							<br/>
							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp (Please Note registered Mobile no will be used for further communications,
							<br/>
				  	...
				  	<div class="panel-body">
                    	...
                    	<form id="stud_reg_form">
	                    	...
	                    	<div class="form-group has-feedback" style="display: none;" id="captcha_box">
	                    		<div class="form-group has-feedback" style="height: 50px;text-align: center;font-size: 30px;background-color: #c9766e66;">
	                    			<span style="font-weight: 700;" id="cap_data_verify"></span>
	                    		</div>
	                    		<br>
	                        	<div class="form-group has-feedback">
		                        	<input type="text" class="form-control cust_ip_border_1"  id="cap_data"  placeholder="ENTER THE CAPTCHA" title="Enter the captcha" autocomplete="off">
		                        	<!-- this cap_data_type is represent as registration from admin panel-->
		                            <input type="hidden" class="form-control"  id="cap_data_type" value="2">
		                        	<span class="glyphicon glyphicon-lock form-control-feedback"></span>
	                        	</div>
	                    	</div>
	                    	<br/>
	                    <!--	<div class="form-group has-feedback">
	                    	...
	                    	<div class="form-group has-feedback">
	                        	...
	                        	<input type="button" class="btn btn-primary btn-block btn-flat" id="send_capta_btn" value="GENERATE CAPTCHA" onclick="captcha()" style="background-color:#c9766e;">
	                    	</div>
	                    	<br/><br/>
	                    </form>
