...
<style>
	...
	<table cellpadding="6" class="table table-striped">
		...
		<tr class="tr_odd">
			...
			<td class="pr_data"><?php echo $app[0]['rm_child_surname']." ".$app[0]['rm_child_name']." ".$app[0]['rm_child_father_name']?></td>
		...
		<tr class="tr_odd">
			<th class="pr_title">COMMUNITY</th>
			<td class="pr_data"><?php echo $app[0]['rm_child_community']?></td>
		...
		<tr class="tr_odd">
			...
			<td class="pr_data"><?php echo $app[0]['rm_child_guardian_office_add'].", ".$app[0]['rm_child_guardian_office_add_city'].", ".$app[0]['rm_child_guardian_office_add_pin_code'].", ".$app[0]['rm_child_guardian_office_add_state']?></td>
			<th class="pr_title">PHONE /MOBILE NO.</th>
			<td class="pr_data"><?php echo $app[0]['rm_child_guardian_phone_no']." / ".$app[0]['rm_child_guardian_mobile_no']?></td>
		</tr>
		<tr class="tr_even">
			<th class="pr_title">EMAIL</th>
	...
	<table cellpadding="6" class="table table-striped">
		...
		<tr>
			<td class="t_n_c">
				...
				<p style="font-size:10px;"><b>g]  </b> Parents are requested to refrain from making defamatory or derogatory remarks about the institution on any search engine or Social Media platforms. In the event of 
				a violation, appropriate action will be initiated against the offender.</p>
