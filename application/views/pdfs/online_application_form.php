<?php
	...
	$file_name = "application_form_".$app[0]['rm_app_no'].".pdf";
	$file_path = 'public/uploads/pdf/'.$file_name;
		...
		<tr>
			<td>
                <span class="tnc">
                	...
                	<a href="#" style="font-size: 18px;color: #d04747;font-weight: bold;margin-left: 10px;"> I have read, understood, and agreed to the above terms & conditions</a></span>
